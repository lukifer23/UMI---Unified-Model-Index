...
15. **Commit phases (1.5):** `40ffb7b` freeze/validate/expand; `75f6cbc` certificate; `f4cc49b` dashboard packaging on `main`. `4896e6e` candidate audits; `de709d1` blocker report; `0ac6a38` phase map; `6ffcbcb` baseline audit; `e4f7db4` weight sensitivity on `feat/umi-v05-governed-public`. No history rewrite.
