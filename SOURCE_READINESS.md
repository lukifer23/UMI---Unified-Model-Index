...
`umi edition --edition v0.5 audit`. Named candidates that miss a required common-core
series stay diagnostic (`umi edition --edition v0.5 candidates`) and do not become scored
rows. That path does not replace this v0.3 readiness gate.
