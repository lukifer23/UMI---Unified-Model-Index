...
|---|---|---|---|---|
| Artificial Analysis | Manually reviewed public index, atomic HLE v4.1, and GDPval-AA v2 facts | `manual-public-facts-2026-08-14`; `reviewed-hle-v4.1-2026-08-14`; `public-page-2026-08-15` | Terms-governed; API documentation and terms require attribution and govern reuse | Facts and citations only; no API payload, task content, work products, or page copy |
...
- Artificial Analysis public model, HLE, GDPval-AA v2, methodology, and API documentation:
